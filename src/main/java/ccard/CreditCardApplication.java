...
public class CreditCardApplication {
    ...
    public static void main(String[] args) {
        ...
        Account creditAccount = creditAccountController.createAccount("xxxssnxx","Mashrabbek", "street", "City", "IA", "52557", "akbarov.dev@gmail.com", dob, AccountType.CREDIT, CreditCardType.GOLD);
        ...
        creditAccountController.addInterest();
